...
public class multi
{
    ...
    // Mapper
    public static class Matrix_Mapper extends Mapper<LongWritable,
Text, Text, Text> {
        public void map(LongWritable key, Text value, Context
mapOutput) throws IOException, InterruptedException {
            ...
            if (splitLineInput[0].equals("M")){
                for (int k=0; k<inputSize; k++){
                    ...
                    outputValue.set(splitLineInput[0] + "," +
splitLineInput[2] + "," + splitLineInput[3]);
                ...
                for (int i=0; i<inputSize; i++){
                    ...
                    outputValue.set(splitLineInput[0] + "," +
splitLineInput[1] + "," + splitLineInput[3]);
                    mapOutput.write(outputKey, outputValue);
                }
            }
        }
...
combineOutput) throws IOException, InterruptedException {
            String[] value, nMatch;
            ...
            for (Text val : values) {
                ...
                if (value[0].equals("M")) {
                    arrayM[Integer.parseInt(value[1])] =
Integer.parseInt(value[2]);
                } else {
                    arrayN[Integer.parseInt(value[1])] =
Integer.parseInt(value[2]);
                }
            }
...
args).getRemainingArgs();
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: matrix multiplication
