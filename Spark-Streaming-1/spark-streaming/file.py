...
def main():
    a = 1
    path="C:/Users/prave/OneDrive/Documents/GitHub/Big-Data-Programing/Spark-Streaming/spark-streaming/"
    with open(path+'lorem.txt', 'r') as file:  # reading content from 'lorem.txt' file
